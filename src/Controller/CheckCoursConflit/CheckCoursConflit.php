...
class CheckCoursConflit extends AbstractController
{
    ...
    public function verifCours(Cours $cours)
    {
        ...
        /**
         * Dans le cas d'une modification, le cours risque de se trouver en conflit avec lui-même.
         * Il faut donc l'enlever du tableau retourné.
         */
        if (isset($coursListe[$cours->getId()])) {
